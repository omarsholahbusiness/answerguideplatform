    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold mb-2" style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("verifyingPayment")}</h1>
          <p className="text-muted-foreground" style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("pleaseWaitForPayment")}</p>
          <p className="text-xs text-muted-foreground mt-2" dir="ltr">{t("verificationAttempt")} {checkCount}/{MAX_CHECKS}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h1 className="text-2xl font-bold mb-2" style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("paymentSuccess")}</h1>
          <p className="text-muted-foreground mb-6" style={{ direction: isRTL ? "rtl" : "ltr" }}>
  ...
  return (
    <div className="h-full flex items-center justify-center">
      <div className="text-center max-w-md mx-auto p-6">
        ...
        <h1 className="text-2xl font-bold mb-2" style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("paymentFailed")}</h1>
        <p className="text-muted-foreground mb-6" style={{ direction: isRTL ? "rtl" : "ltr" }}>
          {t("paymentCanceledOrFailed")}
        </p>
