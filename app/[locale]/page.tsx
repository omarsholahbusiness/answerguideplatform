    ...
    <div className="h-full w-full bg-background">
      ...
      <section id="courses-section" className="py-20 bg-muted/50">
        ...
        >
          ...
          >
            <h2 className="text-3xl font-bold mb-4">{t("exploreCourses")}</h2>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 text-sm text-muted-foreground mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            {course.chapters?.length || 0} {course.chapters?.length === 1 ? t("chapters") : t("chaptersPlural")}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">{t("startLearning")}</h2>
