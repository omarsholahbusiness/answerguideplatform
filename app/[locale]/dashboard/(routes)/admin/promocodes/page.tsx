...
const AdminPromoCodesPage = () => {
    ...
    const fetchCourses = async () => {
        try {
            ...
            if (response.ok) {
                ...
                toast.error(`فشل جلب الكورسات: ${response.status}`);
            }
        } catch (error) {
    ...
    const handleSubmit = async () => {
        ...
        if (!courseId || courseId === "ALL") {
            toast.error("يجب اختيار كورس محدد");
            return;
        }
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="space-y-4 mt-4">
                        <div className="space-y-2">
                            <Label htmlFor="code">اسم الكوبون *</Label>
                            <Input
                                id="code"
                                value={code}
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                                الكوبون سيعطي خصم 100% على هذا الكورس فقط ويمكن استخدامه مرة واحدة فقط
                            </p>
                        </div>
