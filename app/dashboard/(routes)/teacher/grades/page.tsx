                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className={isRTL ? "text-right" : "text-left"}>{t("quiz")}</TableHead>
                                <TableHead className={isRTL ? "text-right" : "text-left"}>{t("course")}</TableHead>
                                <TableHead className={isRTL ? "text-right" : "text-left"}>{t("score")}</TableHead>
                                <TableHead className={isRTL ? "text-right" : "text-left"}>{t("percentage")}</TableHead>
                                <TableHead className={isRTL ? "text-right" : "text-left"}>{t("submissionDate")}</TableHead>
                        ...
                        <div className="space-y-6">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <div className="mt-4">
                                        <div className={`flex items-center ${isRTL ? "justify-between" : "justify-between"} mb-2`}>
                                    ...
                                    <div className="space-y-4">
                                        {selectedResult.answers.map((answer, index) => (
                                            <div key={answer.questionId} className="border rounded-lg p-4">
                                                <div className={`flex items-center ${isRTL ? "justify-between" : "justify-between"} mb-2`}>
                                                    <h4 className="font-medium">{t("questionNumber")} {index + 1}</h4>
                                                    <Badge variant={answer.isCorrect ? "default" : "destructive"}>
                                                        {answer.isCorrect ? t("correct") : t("wrong")}
                                                    </Badge>
                                                </div>
                                                <p className="text-sm text-muted-foreground mb-2" style={{ direction: isRTL ? "rtl" : "ltr" }}>{answer.question.text}</p>
