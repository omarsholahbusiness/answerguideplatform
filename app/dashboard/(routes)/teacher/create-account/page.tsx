    ...
    <div className="p-6 space-y-6">
      <div className={`flex items-center ${isRTL ? "flex-row-reverse" : ""} justify-between`}>
        <div className={`flex items-center ${isRTL ? "flex-row-reverse" : ""} gap-4`}>
          ...
          <h1 className={`text-3xl font-bold text-gray-900 dark:text-white ${isRTL ? "text-right" : "text-left"}`} style={{ direction: isRTL ? "rtl" : "ltr" }}>
      ...
      <div className="max-w-2xl mx-auto">
        {createdUser ? (
          <Card className="border-green-200 bg-green-50 dark:bg-green-950/20">
            <CardHeader>
              <CardTitle className={`flex items-center ${isRTL ? "flex-row-reverse" : ""} gap-2 text-green-700 dark:text-green-300`}>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label className={`text-sm font-medium text-green-700 dark:text-green-300 ${isRTL ? "text-right" : "text-left"}`} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("fullNameLabel")}</Label>
                  <p className={`text-green-800 dark:text-green-200 font-semibold ${isRTL ? "text-right" : "text-left"}`} style={{ direction: isRTL ? "rtl" : "ltr" }}>{createdUser.fullName}</p>
                </div>
                <div>
                  <Label className={`text-sm font-medium text-green-700 dark:text-green-300 ${isRTL ? "text-right" : "text-left"}`} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("phoneNumberLabel")}</Label>
          ...
          <Card>
            <CardHeader>
              <CardTitle className={`flex items-center ${isRTL ? "flex-row-reverse" : ""} gap-2`}>
                <UserPlus className="h-5 w-5" />
                <span className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("studentInfo")}</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="fullName" className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("fullName")} *</Label>
                    <Input
                      id="fullName"
                      name="fullName"
                      type="text"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phoneNumber" className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("phoneNumber")} *</Label>
                    <Input
                      id="phoneNumber"
                      name="phoneNumber"
                      type="tel"
                ...
                <div className="space-y-2">
                  <Label htmlFor="parentPhoneNumber" className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("parentPhone")} *</Label>
                  <Input
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="grade" className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("grade")} *</Label>
                    <Select
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="studyType" className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("studyType")} *</Label>
                    <Select
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="governorate" className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("governorate")} *</Label>
                    <Select
                    ...
                    >
                      ...
                      <SelectContent className="max-h-[300px] overflow-y-auto" dir={isRTL ? "rtl" : "ltr"}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="password" className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("password")} *</Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword" className={isRTL ? "text-right" : "text-left"} style={{ direction: isRTL ? "rtl" : "ltr" }}>{t("confirmPassword")} *</Label>
                    <div className="relative">
                      <Input
                        id="confirmPassword"
                ...
                {formData.password && formData.confirmPassword && (
                  <div className={`text-sm ${isRTL ? "text-right" : "text-left"} ${passwordChecks.match ? 'text-green-600' : 'text-red-600'}`} style={{ direction: isRTL ? "rtl" : "ltr" }}>
                    {passwordChecks.match ? (
                      <span className={`flex items-center ${isRTL ? "flex-row-reverse" : ""} gap-1`}>
