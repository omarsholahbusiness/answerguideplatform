    ...
    <div className="h-full w-full bg-background">
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className={`absolute top-1 ${isRTL ? "-right-2" : "-left-2"}`}
            ...
            <motion.div
              ...
              className={`absolute bottom-1/3 ${isRTL ? "left-6" : "right-6"}`}
              whileHover={{ scale: 1.1, rotate: -5 }}
            >
              <Image
                src="/calculator.png"
            ...
            <motion.div
              ...
              className={`absolute top-1/2 ${isRTL ? "-right-6" : "-left-6"}`}
      ...
      <section id="courses-section" className="py-20 bg-muted/50">
        ...
        >
          ...
          >
            <h2 className="text-3xl font-bold mb-4">{t("availableCourses")}</h2>
              ...
              courses.length === 0 ? (
                <div className="text-center py-12">
                  <div className="max-w-md mx-auto">
                    ...
                    <h3 className="text-lg font-semibold mb-2">{t("noCoursesAvailable")}</h3>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 text-sm text-muted-foreground mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            {course.chapters?.length || 0} {course.chapters?.length === 1 ? t("chapter") : t("chapters")}
                            {course.quizzes && course.quizzes.length > 0 && (
                              <span className={isRTL ? "mr-2" : "ml-2"}>، {course.quizzes.length} {course.quizzes.length === 1 ? t("quiz") : t("quizzes")}</span>
                            )}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Users className="h-4 w-4" />
                          <span>{course.enrollmentCount ?? 0} {t("enrolledStudents")}</span>
                        </div>
                      </div>
                      <Button 
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">{t("studentTestimonials")}</h2>
            <p className="text-muted-foreground">{t("testimonialsDescription")}</p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                name: language === "ar" ? "عصام اسامة" : "Essam Osama",
                grade: t("grade1"),
                testimonial: "تجربة رائعة مع الأستاذ محمد شرح مميز وطريقة سهلة في توصيل المعلومة"
              },
              {
                name: language === "ar" ? "سيف طارق" : "Seif Tarek",
                grade: t("grade2"),
                testimonial: "المنهج منظم جداً والشرح واضح، ساعدني في فهم الانجليزي بشكل أفضل"
              },
              {
                name: language === "ar" ? "عمر جمال" : "Omar Gamal",
                grade: t("grade1"),
              ...
              >
                ...
                <p className="text-muted-foreground text-right" dir="rtl" style={{ direction: "rtl" }}>
      ...
      <section className="py-20 bg-muted/50">
        ...
        >
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl font-bold mb-4">{t("platformFeatures")}</h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">{t("startLearningJourney")}</h2>
