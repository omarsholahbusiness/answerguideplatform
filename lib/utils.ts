 ...
 * @param role - The user's role (can be any case)
 * @returns The normalized role in uppercase
 */
 ...
 * @param role - The user's role
 * @returns True if user is TEACHER or ADMIN
 */
 ...
 */
export function isTeacher(role: string | undefined | null): boolean {
